      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card basic">
            <div class="card-body">
              <h5 class="card-title">What can I do as an Admin?</h5>

              <div>
                <h6>1. Special Features</h6>
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Navigation Guide</h5>
        ...
        <div class="col-lg-6">
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed" data-bs-target="#faqsOne-3" type="button" data-bs-toggle="collapse">
                      How can I see recent updates made to the website?
                    </button>
                  </h2>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed" data-bs-target="#faqsOne-4" type="button" data-bs-toggle="collapse">
                      How can I view all the accounts currently using this website?
                    </button>
                  </h2>
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Controls Guide</h5>
