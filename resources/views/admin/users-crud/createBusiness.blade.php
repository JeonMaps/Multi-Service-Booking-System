                    ...
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form class="row g-3 needs-validation" novalidate form method="POST" action="{{ route('users.store-business') }}">
                                    @csrf
                                    ...
                                    <div class="col-md-12">
                                        <label for="service_provider_id" class="form-label">Service Provider</label>
                                            ...
                                            <select id="service_provider_id"
                                                class="form-control @error('service_provider_id') is-invalid @enderror"
                                                name="service_provider_id" required>
                                                <option value="">--Select an option--</option>
                                                <option value="">None</option>
                                                @foreach ($serviceProviders as $serviceProvider)
                                                    <option value="{{ $serviceProvider->id }}"
                                                        @if (old('service_provider_id') == $serviceProvider->id) selected @endif>
                                    ...
                                    <div class="col-md-12">
                                        <input id="role" name="role" value="Service Provider" hidden>
