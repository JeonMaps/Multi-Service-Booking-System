                ...
                <div class="col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body pb-0">
                            <h5 class="card-title">Most Popular Services <span>| Top 6 </span></h5>
                            ...
                            foreach($services as $item){
                                echo "<input type='text' id=".$custom_id." name=".$item->category." value=".$item->total." hidden>";
                                $custom_id++;
                            }
                            ?>

                            <script type="text/javascript">
                                var $name1 = document.getElementById("1").name;
                                var $num1 = document.getElementById("1").value;
                                var $name2 = document.getElementById("2").name;
                                var $num2 = document.getElementById("2").value;
                                var $name3 = document.getElementById("3").name;
                                var $num3 = document.getElementById("3").value;
                                var $name4 = document.getElementById("4").name;
                                var $num4 = document.getElementById("4").value;
                                var $name5 = document.getElementById("5").name;
                                var $num5 = document.getElementById("5").value;
                                var $name6 = document.getElementById("6").name;
