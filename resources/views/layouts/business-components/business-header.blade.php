@section('header')
    <header id="header" class="header fixed-top d-flex align-items-center navbar-admin-custom">
        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            <a href="{{ route('business.home') }}" class="logo d-flex align-items-center">
                <span class="d-none d-lg-block text-color-custom-1">MSABS Business</span>
                <img src="admin-assets/img/admin_logo_test_01.png" alt="" class="img-fluid">
            </a>
        </div><!-- End Logo -->
